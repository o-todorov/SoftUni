...
//	for ( auto a : _activeArrays ) a.print("Destruct");
//}
...
void CommandExecutor::executeCreateArray(const int arraySize)
{
	...
	//_activeArrays[_activeArrays.size()-1].print("executeCreateArray:");
}
...
void CommandExecutor::executeCopyAssignArray(const int fromIdx, const int toIdx)
{
	...
	//_activeArrays[toIdx].print("executeCopyAssignArray:");
}
...
void CommandExecutor::executeSumArrayData(const int arrayIdx)
{
	...
	//_activeArrays[arrayIdx].print("executeSumArrayData:");
                                                ...
                                                const int arrayIdx)
{
	...
	//_activeArrays[arrayIdx].print("executeIncrArrayDataValue:");
}
